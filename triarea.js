...
function caltArea(){
    ...
    if(isNaN(areaBase)){
        ...
        document.getElementById('result1').innerHTML = `Alert! Triangle Base value is empty.`;
    }
    else if(isNaN(areaHeight)){
        document.getElementById('result1').style.color='red';
        document.getElementById('result1').style.background='yellow';
        document.getElementById('result1').innerHTML = `Alert! Triangle Height value is empty.`;
    }
    else{
